...
# Deploy to staging
declare -a images=("staging-app" "staging-worker-mailer-campaign" "staging-worker-mailer-transactional" "staging-worker-referent" "staging-worker-cp-summary-consumer", "staging-worker-cp-summary-producer")
