    ...
    """
    {
      ...
      "Email": "jp@test.com",
          ...
          "Vars": {
            ...
            "confirmation_link": "http:\/\/enmarche.dev\/inscription\/finaliser\/@string@\/@string@?redirect_uri=https%3A\/\/en-marche.fr\/callback&client_id=f80ce2df-af6d-4ce4-8239-04cfcefd5a19"
          }
        }
      ]
    }
    """
    When I click on the email link "confirmation_link"
